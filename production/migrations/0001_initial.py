...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Artwork',
            fields=[
                ('production_ptr', models.OneToOneField(parent_link=True, auto_created=True, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='production.Production')),
        ...
        migrations.CreateModel(
            name='Exhibition',
            fields=[
                ('event_ptr', models.OneToOneField(parent_link=True, on_delete=django.db.models.deletion.CASCADE, auto_created=True, primary_key=True, serialize=False, to='production.Event')),
            ],
        ...
        migrations.CreateModel(
            name='Film',
            fields=[
                ('artwork_ptr', models.OneToOneField(parent_link=True, on_delete=django.db.models.deletion.CASCADE, auto_created=True, primary_key=True, serialize=False, to='production.Artwork')),
            ],
        ...
        migrations.AddField(
            model_name='itinerary',
            name='event',
            field=models.ForeignKey(related_name='itineraries', on_delete=django.db.models.deletion.PROTECT, to='production.Event'),
        ),
        migrations.AddField(
            model_name='event',
            name='place',
