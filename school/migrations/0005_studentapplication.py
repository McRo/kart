    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artistic_referencies_project_1', models.FileField(help_text=b"Artistic references for first first year's project", null=True, upload_to=common.utils.make_filepath, blank=True)),
                ...
                ('artistic_referencies_project_2', models.FileField(help_text=b"Artistic references for second first year's project", null=True, upload_to=common.utils.make_filepath, blank=True)),
                ...
                ('cursus_justifications', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_application_cursus_justification', blank=True, to='assets.Gallery', help_text=b'Gallery of justificaitons', null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AlterField(
            model_name='student',
            name='artist',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student', to='people.Artist'),
        ),
    ]
